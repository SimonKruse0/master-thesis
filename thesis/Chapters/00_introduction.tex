...
\begin{figure}[H]%
    \centering
    \subfloat[\centering GP]{{\includegraphics[trim=0.1cm 0.3cm 0.2cm 0.2cm,clip,width=0.46\textwidth]{Pictures/GP_vs_BNN1_b.pdf} }}%
    \qquad
    \subfloat[\centering BNN]{{\includegraphics[trim=0.1cm 0.3cm 0.2cm 0.2cm,clip,width=0.46\textwidth]{Pictures/GP_vs_BNN2.pdf} }}%
