...
% \subsubsection{Discriminative model as surrogate model}
...
% \subsubsection{Using a generative model as surrogate model}
% ..
...
\subsubsection{Exact expected improvement}
