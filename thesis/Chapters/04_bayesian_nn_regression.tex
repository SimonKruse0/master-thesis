...
\end{align*}
where the integral is intractable. As indicated in the second line, we can approximated the
...
and the one from the paper, BOHamiANN, \cite{BOHAMIANN}. 
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.5\textwidth]{Pictures/_.pdf}
