...
In Figure \ref{Test_bayesOpt} top left, the methods have been tested on Test1, which the benchmark
...
First, compared to the 1D test, BNN suddenly gives relatively high
