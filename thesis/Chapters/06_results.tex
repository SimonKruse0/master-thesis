...
The first problem will establish some benchmark since this is a simple function to fit. This should
be an easy task for the discriminative models and indeed the predictive mean yields a small relative
error for the test1.  
