...
\section{Model compartment on test problems (Bayesian Optimization)}
...
\section{BBOB-2015 noiseless testbed}
... Benchmark problem set. We evaluate the optimization methods on the BBOB-2015 noiseless
...
the benchmark and specifications of each function). Due to the limitation
of time and resources, only 15 independent trials were preformed for each
method on each function in a set of two, three, five, and ten dimensional
