...
off_set = 0
plt.fill_betweenx(y_grid, 0*p_y+y_min+off_set, p_y/50+y_min+off_set, color = "#D0021B")
plt.fill_between(x_grid, 0*p_x+x_min+off_set, p_x/50+x_min+off_set, color = "tab:orange")
