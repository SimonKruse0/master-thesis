...
reg_models = [BOHAMIANN(num_warmup=50*200,num_samples=10000, num_keep_samples=50)]
...
# #SINGLE TEST
for problem_sklearn in [Test2()]:# [Test1(),Test2(),Test3(),Test4(),Test3b()]:
    for reg_model in reg_models:
        ...
        try:
            ...
            pass
        for samples in [50]:#[int(x) for x in np.logspace(1, 2.5, 9)]:
