...
def plot_regression_paths(problem_name, plot_type=0):
    ...
    legend_names =  plot_means(ax,data_list,name_list,type=type, search_name = "BOH", color = "yellow", modelname = "BOHAMIANN")
    ...
    legend_names += plot_means(ax,data_list,name_list,type=type, search_name = "BNN", color = "orange", modelname = "BNN")
...
if __name__ == "__main__":
    if data_folder == "coco_reg_data":
        ...
        while True:
            ...
            plot_regression_paths(problem_name, plot_type=int(type))